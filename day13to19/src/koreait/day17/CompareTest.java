...
public static void main(String[] args) {
	//값의 비교:기본 데이터 외에 객체 타입 비교를 인터페이스를 활용해 봅니다
	
	List<Integer>list1 =new ArrayList<>();
	
	List<String> list2 =new ArrayList<String>();// 문자열  String은 클래스
	...
	list2.sort(null);			//사전식 정렬(알파벳순,가나다순)
