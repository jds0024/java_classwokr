...
// ->커스텀생성자:필드값 초기화를 위해서 인자가 있는 형식의 생성자	
	...
	public MyClass1() {}
	//커스텀 생성자를 정의하면 기본생성자는 생략을 할 수 없다->필요하다면 기본 생성자 정의가 필요함.
	//->객체 생성할때 new MyClass1() 허용하지 않겠다면, 기본생성자 정의 12번 라인 쓰지 않습니다.
		
	
	public MyClass1(int f1) {
		this.f1=f1;   //이 객체의 f1필드값.,this는 new연산으로 만들어지는 객체
	}
